...
<head>
    ...
    <style>
        ...
        .btn-hapus-usulan:hover,
        .btn-hapus-usulan:focus {
            background: #991b1b;
            color: #ffffff;
            border-color: #991b1b;
        }

        .btn-template-excel i,
        .btn-hapus-usulan i {
            ...
            <main class="content-wrap">
                ...
                <div class="d-md-none mobile-nav mobile-header shadow-sm mb-3">
                    ...
                    <div class="mobile-header-menu">
                        <div class="d-flex gap-2 flex-nowrap text-center menu-scroll overflow-auto">
                            <a href="#top" class="mobile-menu-btn active">
                                <i class="bi bi-grid"></i>
                                <small>Dashboard</small>
                            </a>

                            <a href="#panelPeta" class="mobile-menu-btn">
                                <i class="bi bi-map"></i>
                                <small>Peta</small>
                            </a>

                            <a href="#panelData" class="mobile-menu-btn">
                                <i class="bi bi-table"></i>
                                <small>Data</small>
                            </a>

                            <a href="#panelStatistik" class="mobile-menu-btn">
                                <i class="bi bi-bar-chart"></i>
                                <small>Statistik</small>
                            </a>

                            <a href="#uploadSection" class="mobile-menu-btn">
                ...
                <div class="page-header mb-4">
                    ...
                    <div class="page-header-right">
                        ...
                        <a href="logout.php" class="btn btn-sm rounded-4 px-3" style="border:1px solid var(--primary-esdm); color:#111111; background:var(--primary-esdm); font-weight:600;">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6 col-xl-20">
                        <div class="card card-soft stat-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="icon-box" style="background:#fff8cc;color:#111111;"><i class="bi bi-file-earmark-text"></i></div>
                                <div>
                    ...
                    <div class="col-md-6 col-xl-20">
                        <div class="card card-soft stat-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="icon-box" style="background:#fff3b0;color:#111111;"><i class="bi bi-bounding-box"></i></div>
                                <div>
                    ...
                    <div class="col-md-6 col-xl-20">
                        <div class="card card-soft stat-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="icon-box" style="background:#f3f4f6;color:#111111;"><i class="bi bi-gear"></i></div>
                                <div>
                    ...
                    <div class="col-md-6 col-xl-20">
                        <div class="card card-soft stat-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="icon-box" style="background:#fff8cc;color:#111111;"><i class="bi bi-search"></i></div>
                                <div>
                    ...
                    <div class="col-md-6 col-xl-20">
                        <div class="card card-soft stat-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="icon-box" style="background:#f3f4f6;color:#111111;"><i class="bi bi-shield-check"></i></div>
                                <div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="map-toolbar d-flex flex-wrap align-items-center gap-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-dark rounded-3 map-toolbar-btn" id="fullscreenMapBtn">
                                        ...
                                        <div class="map-legend ms-1">
                                            ...
                                            <!-- Legend WP, default disembunyikan -->
                                            <div id="legendWP" style="display:none; display:flex; gap:12px; flex-wrap:wrap; align-items:center;">
                                                <div class="legend-item">
                                                ...
                                                <div class="legend-item">
                                                    <span class="legend-dot" style="background:#fef3c7; border:1px solid #a16207;"></span>
                                                    <span>WUP</span>
                                                </div>

                                                <div class="legend-item">
                                                    <span class="legend-dot" style="background:#a3e635"></span>
                                                    <span>WPR</span>
                                                </div>
                                            </div>
                                ...
                                <div id="ringkasanOverlap" class="mt-3 overlap-panel" style="display:none;">
                                    <div class="card border-0 rounded-4" style="background:#fffef7; border:1px solid #f2d500;">
                                        <div class="card-body">
                                ...
                                <div id="detailOverlapWrapper" class="card border-0 rounded-4 mt-3" style="background:#ffffff; border:1px solid #e5e7eb; display:none;">
                                    <div class="card-body">
                ...
                <div class="card card-soft mt-3" id="panelData">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            ...
                            <button class="btn btn-refresh-data btn-sm rounded-4 px-3" id="refreshButton">
                ...
                <div class="card card-soft mt-3" id="uploadSection">
                    <div class="card-body">
                        <div class="d-flex gap-2 flex-wrap mb-3">
                            <button class="btn btn-warning rounded-4 px-4 fw-semibold text-dark" data-bs-toggle="modal" data-bs-target="#uploadModal">
                                <i class="bi bi-upload me-2"></i>Upload Excel WIUP
                            </button>

                            <a class="btn btn-template-excel rounded-4 px-4" href="data/template_wiup_usulan.xlsx" download>
                                <i class="bi bi-download me-2"></i>Template Excel
                            </a>

                            <button class="btn btn-hapus-usulan rounded-4 px-4" id="refreshUsulanWiup">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4">
			...
			<input type="file" class="form-control" id="uploadExcel" accept=".xlsx" required>
                    ...
                    <div class="alert border rounded-4 small mb-0" style="background:#fffef7; border-color:#f2d500 !important; color:#374151;">
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn rounded-4 px-4" data-bs-dismiss="modal" style="border:1px solid #d1d5db; background:#ffffff; color:#111111; font-weight:600;">Tutup</button>
                <button type="button" class="btn rounded-4 px-4" id="submitUpload" style="background:var(--primary-esdm); color:#111111; border:1px solid var(--primary-esdm); font-weight:700;">Upload Sekarang</button>
            </div>
        </div>
    </div>
</div>
...
let map, statusChart, komoditasChart, activeHighlightLayer, activeFeatureLayer, polygonLayer, layerWP;
let nomorSkTerpilih = '';
...
async function getWPData() {
    const response = await fetch('data/wp_sumut.geojson');
    return await response.json();
}
...
function toggleLegendWP(show) {
    const legendWP = document.getElementById('legendWP');
    if (!legendWP) return;

    legendWP.style.display = show ? 'flex' : 'none';
}
...
function updateTombolLokasiSaya(isActive) {
    ...
    if (isActive) {
        ...
        btn.innerHTML = '<i class="bi bi-crosshair me-1"></i>Sembunyikan Lokasi';
    } else {
...
function updateTombolTracking(isActive) {
...
function hapusLayerLokasi() {
    ...
    if (circleLokasiSaya && map) {
        ...
        circleLokasiSaya = null;
    }
}

function stopTrackingLokasi(resetTampilan = true) {
    ...
    if (resetTampilan) {
        updateTombolTracking(false);
    }
}

function toggleLokasiSaya() {
    if (!navigator.geolocation) {
        alert('Browser ini tidak mendukung lokasi.');
        return;
    }

    // Jika tracking aktif, matikan dulu agar tidak bentrok
    if (watchLokasiSayaId !== null) {
        stopTrackingLokasi(true);
    }

    // Jika lokasi sedang tampil, klik lagi untuk menyembunyikan
    if (markerLokasiSaya || circleLokasiSaya) {
        hapusLayerLokasi();
        updateTombolLokasiSaya(false);
        return;
    }
...
function toggleTrackingLokasi() {
    ...
    // Jika tracking sedang aktif, klik lagi untuk stop total
    if (watchLokasiSayaId !== null) {
        stopTrackingLokasi(true);
        updateTombolLokasiSaya(false);
        return;
    ...
    // Jika sebelumnya ada marker dari "Lokasi Saya", bersihkan dulu
    hapusLayerLokasi();
    updateTombolLokasiSaya(false);
    ...
    watchLokasiSayaId = navigator.geolocation.watchPosition(
        function (position) {
            ...
            updateTombolTracking(true);
            updateTombolLokasiSaya(false);
        },
        function (error) {
            console.error('Gagal tracking lokasi:', error);

            let pesan = 'Tracking lokasi gagal dijalankan.';
            if (error.code === 1) pesan = 'Izin lokasi ditolak.';
            if (error.code === 2) pesan = 'Lokasi tidak tersedia.';
            if (error.code === 3) pesan = 'Permintaan lokasi timeout.';
            alert(pesan);
...
function hitungLuasUsulanHa(coords) {
    ...
    if (titikAwal[0] !== titikAkhir[0] || titikAwal[1] !== titikAkhir[1]) {
        ring.push(titikAwal);
    }

    const polygon = turf.polygon([ring]);
    const luasMeter = turf.area(polygon);

    return luasMeter / 10000;
}
...
function gambarUsulanWiup(zoomKeUsulan = false) {
    ...
    const namaUsulan = infoUsulan?.nama_usulan || '-';
    const kabupaten = infoUsulan?.kabupaten || '-';
    const komoditas = infoUsulan?.komoditas || '-';
    const luasHa = hitungLuasUsulanHa(coordsUsulan);

    const popupContent = `
        <div style="min-width:220px">
            <div style="font-weight:700; font-size:14px; margin-bottom:8px; color:#111111;">
                Usulan WIUP
            </div>
            <table style="width:100%; font-size:13px; line-height:1.5;">
                ...
                <tr>
                    <td><b>Luas</b></td>
                    <td>: ${formatNumber(luasHa, 2)} Ha</td>
                </tr>
            </table>
        </div>
    `;

    window.usulanLayer.bindPopup(popupContent);
...
function initMap() {
    ...
    map.createPane('paneWP');
    map.getPane('paneWP').style.zIndex = 200;

    map.createPane('paneIUP');
    map.getPane('paneIUP').style.zIndex = 400;
    ...
    getWPData()
        .then(wpData => {
            layerWP = L.geoJSON(wpData, {
                pane: 'paneWP',
                style: function(feature) {
                    const p = feature.properties || {};
                    const jenis = String(p.wilayah || p.WILAYAH || '').toUpperCase().trim();

                     // WPN → merah
                    if (jenis === 'WPN') {
                        return {
                            color: '#b91c1c',      // border merah tegas
                            weight: 3,
                            fillColor: '#ef4444',
                            fillOpacity: 0.35      // 🔥 naikkan dari 0.15
                        };
                    }

                    // WUP → krem / kuning pucat
                    if (jenis === 'WUP') {
                        return {
                            color: '#92400e',
                            weight: 3,
                ...
                onEachFeature: function(feature, layer) {
                    ...
                    layer.bindPopup(`
                        <div style="min-width:180px">
                            <b>Wilayah Pertambangan</b><br><br>
                            <b>Region:</b> ${p.region || '-'}<br>
                            <b>Wilayah:</b> ${p.wilayah || '-'}
                        </div>
                    `);
                }
            });

            layerControl.addOverlay(layerWP, 'Wilayah Pertambangan');

            map.on('overlayadd', function(e) {
                if (layerWP && e.layer === layerWP) {
                    toggleLegendWP(true);
                }
            });
            ...
            map.on('overlayremove', function(e) {
                if (layerWP && e.layer === layerWP) {
                    toggleLegendWP(false);
                }
            });
        })
        .catch(error => {
            console.error('Gagal memuat layer WP:', error);
        });
...
function renderPagination(totalData, mulai, akhir) {
    ...
    tombolSebelum.className = 'btn btn-sm btn-page-nav';
    ...
    tombolBerikut.className = 'btn btn-sm btn-page-nav';
    ...
    try {
        ...
        jsonData = jsonData.map(row => {
            ...
            Object.keys(row).forEach(key => {
                const keyNormal = String(key).trim().toLowerCase().replace(/\s+/g, '_');
                rowBaru[keyNormal] = row[key];
            });
            return rowBaru;
        });
                ...
                const kolomFile = Object.keys(jsonData[0]);
...
document.getElementById('btnLokasiSaya').addEventListener('click', toggleLokasiSaya);
